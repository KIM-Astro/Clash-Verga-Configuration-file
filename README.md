...
经常不知道该选哪个节点？受够了机场自带配置里几十个花里胡哨、乱七八糟的代理组？甚至连下一个网页的 IP 被丢到了哪里都不知道？
...
不用再对着几十个节点发呆了。直接在“🚀 区域切换”里点选你想连接的国家/地区，一步到位。
...
### 第一步：编辑并注入“扩展脚本”
1. 打开 **Clash Verge   冲突边缘**，点击左侧导航栏的“订阅”。
...
4. 再次右键点击刚才的机场订阅，选择 **“扩展脚本”**。*（请注意，不是“全局扩展脚本”）*
